...
\shortcite{JerabBBFA:2010} employed a method similar to the one
...
voxel grid. Finally, Zhao and Barbi\v{c} \shortcite{ZhaoB:2013}
...
\shortcite{KaufmMBG:2009} used discontinuous Galerkin FEM
...
Zeltzer \shortcite{ChenZ:1992} focused on anatomical structures such
...
Hermann et al.\!  \shortcite{HermaRF:2009} analyzed data flow in their
...
leveraged by M\"{u}ller et al.~\shortcite{MulleTG:2004} for deformable
